...
__all__ = [
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SGRsAdd', 'SPGS_EXCLUSIVE',
    'SPSEMANTICFORMAT', 'DISPID_SpeechPhraseRules',
    'SAFT24kHz8BitMono', 'SVP_3', 'DISPID_SLWsItem', 'SRSActive',
    'SPPS_RESERVED1', 'DISPID_SPRsItem',
    'SpeechStreamSeekPositionType', 'SPBO_AHEAD', 'SPBO_NONE',
    'SPSNotOverriden', 'SAFT11kHz8BitStereo', 'DISPID_SRAudioInput',
    'DISPID_SRCPause', 'eLEXTYPE_PRIVATE4', 'ISpeechRecoResultTimes',
    'SVSFIsFilename', 'DISPID_SGRsCommit', 'SPEI_REQUEST_UI',
    'DISPIDSPTSI_ActiveLength', 'SPSHT_OTHER', 'DISPID_SWFEChannels',
    'SPSHT_NotOverriden', 'SpPhoneticAlphabetConverter',
    'SpeechCategoryAudioIn', 'SGRSTTTextBuffer', 'ISpAudio',
    'SREAdaptation', 'DISPID_SPPParent', 'SVP_2',
    'DISPID_SRIsUISupported', 'DISPID_SDKSetLongValue', 'SRSInactive',
    'DISPID_SMSADeviceId', 'DISPID_SRSSupportedLanguages',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SVSLastBookmarkId',
    'SBOPause', 'DISPID_SVSkip', 'Speech_Max_Pron_Length',
    'ISpRecoContext', 'eLEXTYPE_PRIVATE5', 'SVPNormal',
    'SGDSActiveWithAutoPause', 'eLEXTYPE_RESERVED7',
    'DISPID_SAEventHandle', 'Speech_Default_Weight', 'SPPS_Unknown',
    'SGRSTTWord', 'ISpPhraseAlt', 'DISPID_SPRuleChildren',
    'DISPID_SPPs_NewEnum', 'eLEXTYPE_RESERVED9', 'SDKLLocalMachine',
    'SVP_8', 'SPXRO_Alternates_SML', 'DISPID_SpeechAudioFormat',
    'DISPID_SpeechAudio', 'ISequentialStream',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SOTIsUISupported',
    'ISpRecoContext2', 'SpeechRecognizerState', 'SpeechRecoEvents',
    'DISPID_SRGState', 'SRERecoOtherContext', 'eLEXTYPE_PRIVATE1',
    'SpeechPropertyNormalConfidenceThreshold', 'eLEXTYPE_PRIVATE10',
    'SGDSInactive', 'SAFT32kHz16BitMono', 'DISPID_SPEsItem',
    'SAFT8kHz8BitStereo', 'DISPID_SOTCEnumerateTokens', 'SVP_6',
    'DISPID_SRCEPropertyStringChange', 'eLEXTYPE_PRIVATE13',
    'SITooLoud', 'SPEI_TTS_AUDIO_LEVEL', 'ISpeechGrammarRule',
    'SPPS_SuppressWord', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SRRSpeakAudio', 'SGRSTTEpsilon', 'SVEPhoneme',
    'SPSHORTCUTPAIRLIST', 'DISPID_SRCRequestedUIType',
    'DISPID_SRCRetainedAudio', 'eLEXTYPE_LETTERTOSOUND',
    'SPPARTOFSPEECH', 'SDTRule', 'DISPID_SOTsItem',
    'eLEXTYPE_PRIVATE20', 'SVSFUnusedFlags', 'SSTTDictation',
    'DISPID_SLPLangId', 'ISpObjectToken', 'SpeechUserTraining',
    'DISPID_SADefaultFormat', 'SAFTADPCM_11kHzMono', 'SVP_11',
    'DISPID_SRRecognizer', 'DISPID_SPRsCount', 'SPSERIALIZEDRESULT',
    'SPAUDIOOPTIONS', 'SAFTGSM610_22kHzMono', 'SPAS_RUN',
    'SVSFlagsAsync', 'SECFIgnoreKanaType', 'SAFT12kHz8BitMono',
    'SpeechTokenKeyUI', 'SPDKL_DefaultLocation', 'SP_VISEME_19',
    'SpUnCompressedLexicon', 'DISPID_SRCERecognition',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SRRAudioFormat',
    'ISpeechVoiceStatus', 'DISPID_SLPsCount', 'DISPID_SVEVoiceChange',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SPINTERFERENCE_TOOFAST',
    'SLTApp', 'SAFT8kHz8BitMono', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SRCRecognizer', 'ISpGrammarBuilder', 'SPLO_STATIC',
    'DISPID_SpeechObjectTokens', 'SPSHORTCUTPAIR',
    'SpeechEmulationCompareFlags', 'SPEI_INTERFERENCE',
    'ISpPhoneConverter', 'DISPID_SRRRecoContext',
    'DISPID_SpeechBaseStream', 'DISPID_SRSCurrentStreamNumber',
    'SPPS_NotOverriden', 'SPWORDTYPE', 'STCAll', 'SVP_16',
    'SSTTTextBuffer', 'DISPID_SABIBufferSize',
    'DISPID_SpeechRecoContext', 'SAFTGSM610_44kHzMono',
    'SP_VISEME_17', 'SpeechWordType', 'DISPID_SpeechVoice',
    'SREStreamEnd', 'SP_VISEME_4', 'SpeechAllElements',
    'SPAUDIOSTATUS', 'STCInprocServer', 'SpShortcut',
    'SpeechGrammarRuleStateTransitionType', 'SP_VISEME_10',
    'DISPID_SDKCreateKey', 'ISpeechObjectTokens',
    'DISPID_SPERetainedStreamOffset', 'SDTDisplayText', 'SINone',
    'ISpeechResourceLoader', 'SpeechRunState', 'SAFT44kHz8BitMono',
    'SpeechAudioState', 'DISPID_SVSLastStreamNumberQueued',
    'SPLEXICONTYPE', 'DISPID_SWFEBlockAlign', 'ISpeechVoice',
    'DISPID_SRIsShared', 'STSF_CommonAppData', 'eLEXTYPE_PRIVATE2',
    'ISpLexicon', 'SAFT16kHz8BitMono', 'SRCS_Enabled',
    'SECNormalConfidence', 'SDTReplacement',
    'ISpeechPhraseProperties', 'ISpeechMemoryStream',
    'DISPID_SPEAudioTimeOffset', 'SpeechLexiconType',
    'DISPID_SPEEngineConfidence',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SRRTStreamTime',
    'DISPID_SGRsCount', 'SVSFIsXML', 'SVEPrivate',
    'DISPID_SpeechRecoContextEvents', 'SPWT_PRONUNCIATION',
    'SPRS_ACTIVE_USER_DELIMITED', 'SSSPTRelativeToStart',
    'SPLO_DYNAMIC', 'DISPID_SABufferNotifySize',
    'SAFT24kHz8BitStereo', 'SAFTGSM610_8kHzMono', 'DISPID_SOTId',
    'SRERecognition', 'SGDSActiveUserDelimited', 'eLEXTYPE_PRIVATE14',
    'DISPID_SPPId', 'STSF_AppData', 'DISPID_SRCESoundStart',
    'eLEXTYPE_MORPHOLOGY', 'SpeechVoiceSpeakFlags',
    'DISPID_SPRuleEngineConfidence', 'SDTAll',
    'DISPID_SDKDeleteValue', 'SpeechDataKeyLocation', 'SRTStandard',
    'SPSERIALIZEDPHRASE', 'ISpeechPhraseInfoBuilder',
    'SECFIgnoreWidth', 'SpeechAddRemoveWord',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SPRFirstElement',
    'SpeechEngineConfidence', 'DISPID_SRCResume',
    'DISPID_SpeechLexiconWord', 'SpMMAudioOut',
    'SpeechPropertyResponseSpeed', 'DISPID_SDKDeleteKey',
    'SVSFParseSapi', 'SVEAllEvents', 'SREStateChange',
    'DISPID_SRSetPropertyNumber', 'SLODynamic', 'SPVISEMES',
    'DISPID_SWFEExtraData', 'DISPID_SLAddPronunciationByPhoneIds',
    'SPAR_Low', 'SPEI_VOICE_CHANGE',
    'SpeechPropertyHighConfidenceThreshold',
    'SpeechTokenIdUserLexicon', 'DISPID_SAFType', 'SPAUDIOSTATE',
    'SPWT_LEXICAL', 'DISPID_SLWs_NewEnum', 'DISPID_SLPType',
    'DISPID_SRGCommit', 'SPAS_STOP', 'SpeechVoiceCategoryTTSRate',
    'SpeechStreamFileMode', 'SpeechLoadOption',
    'DISPID_SRCEEnginePrivate', 'SPWORDLIST',
    'DISPID_SpeechObjectToken', 'DISPID_SpeechObjectTokenCategory',
    'SGLexical', 'SPINTERFERENCE_NOISE', 'SAFT48kHz16BitMono',
    'DISPID_SRCEStartStream', 'DISPID_SRGRecoContext',
    'SPEI_RECO_STATE_CHANGE', 'SRTEmulated', 'DISPID_SPRText',
    'ISpNotifyTranslator', 'SPWORD', 'DISPID_SOTCDefault',
    'ISpSerializeState', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SPIGrammarId', 'DISPID_SpeechGrammarRuleState',
    'SECFNoSpecialChars', 'SpeechVoiceSkipTypeSentence',
    'SpeechRecognitionType', 'DISPID_SVSRunningState',
    'ISpeechAudioBufferInfo', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SPRDisplayAttributes', 'ISpeechGrammarRuleState',
    'SPVPRI_NORMAL', 'eLEXTYPE_USER_SHORTCUT',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SAFGuid', 'DISPID_SVGetVoices',
    'DISPID_SOTGetAttribute', 'DISPID_SOTs_NewEnum',
    'SRSActiveAlways', 'SINoise', 'SGPronounciation',
    'DISPID_SVVoice', 'DISPID_SPEActualConfidence', 'SRTAutopause',
    'SFTInput', 'DISPID_SPIStartTime', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SLPs_NewEnum', 'SPSSuppressWord', 'SPEI_RESERVED1',
    'SpeechTokenKeyFiles', 'DISPID_SRGetPropertyNumber',
    'ISpeechObjectToken', 'SPXMLRESULTOPTIONS', 'SVP_12',
    'SSSPTRelativeToEnd', 'SpObjectTokenCategory',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SMSALineId',
    'DISPID_SpeechCustomStream', 'DISPID_SRGCmdSetRuleIdState',
    'DISPID_SVAudioOutputStream', 'DISPID_SRRSetTextFeedback',
    'DISPID_SREmulateRecognition', 'SSFMCreate', 'SPRS_INACTIVE',
    'SVP_0', 'ISpeechLexicon', 'SITooSlow', 'SAFTADPCM_8kHzMono',
    'SITooQuiet', 'SpInProcRecoContext', 'DISPID_SLWLangId',
    'DISPID_SRGDictationSetState', 'SVP_9',
    'DISPID_SpeechLexiconWords', 'SpMMAudioEnum',
    'Speech_Max_Word_Length', 'eLEXTYPE_VENDORLEXICON',
    'SVSFParseSsml', 'ISpeechFileStream', 'SSTTWildcard',
    'SPDATAKEYLOCATION', 'SRAExport', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SGRSAddSpecialTransition', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SpeechXMLRecoResult', 'ISpEventSource',
    'STCInprocHandler', 'DISPID_SVEPhoneme',
    'DISPID_SAFSetWaveFormatEx', 'SREInterference',
    'tagSPPROPERTYINFO', 'DISPID_SFSClose', 'DISPID_SRCVoice',
    'DISPID_SVSLastBookmark', 'eLEXTYPE_PRIVATE18',
    'SpeechWordPronounceable', 'SPFM_CREATE_ALWAYS',
    'DISPID_SPAsItem', 'DISPID_SpeechDataKey', 'SpMMAudioIn',
    'DISPID_SPIGetDisplayAttributes', 'SPPHRASEELEMENT',
    'SPEI_RESERVED3', 'SpeechGrammarWordType', 'SPPHRASEREPLACEMENT',
    'SVSFPurgeBeforeSpeak', 'SPDKL_LocalMachine',
    'DISPID_SPPFirstElement', 'DISPID_SLWPronunciations', 'ISpStream',
    '_ISpeechRecoContextEvents', 'SPSUnknown', 'ISpResourceManager',
    'DISPID_SLWType', 'SAFT44kHz16BitStereo', 'SpWaveFormatEx',
    'DISPID_SVSInputWordPosition', 'DISPID_SpeechPhraseReplacements',
    'SPRULESTATE', 'DISPID_SPRuleName', 'SAFT32kHz8BitMono',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SPEAudioSizeBytes',
    'SpObjectToken', 'SWPUnknownWordUnpronounceable',
    'STCRemoteServer', 'SPRECOSTATE',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SLWWord',
    'SPSMF_SRGS_SAPIPROPERTIES', 'ISpeechAudioFormat',
    'SPPS_RESERVED2', 'DISPID_SpeechPhraseBuilder', 'DISPIDSPRG',
    'DISPID_SVEEnginePrivate', 'eWORDTYPE_DELETED',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SRSNumberOfActiveRules',
    'SpeechEngineProperties', 'SPEI_SR_PRIVATE',
    'DISPID_SRGDictationLoad', 'SP_VISEME_9', 'SVPAlert',
    'DISPID_SLGetGenerationChange', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SPEDisplayAttributes', 'DISPID_SDKGetlongValue',
    'SDA_One_Trailing_Space', 'ISpeechRecoResult', 'SVSFVoiceMask',
    'DISPID_SpeechPhraseProperties',
    'DISPID_SpeechLexiconPronunciation', 'SPPS_Noncontent',
    'DISPID_SGRsCommitAndSave', 'ISpeechBaseStream', 'SPCS_ENABLED',
    'SGRSTTDictation', 'ISpNotifySource', 'DISPID_SRRTTickCount',
    'DISPID_SOTGetStorageFileName', 'SpInprocRecognizer',
    'SVEWordBoundary', 'SPLOADOPTIONS', 'DISPID_SRGetRecognizers',
    'SDKLCurrentUser', 'SpeechMicTraining', 'DISPID_SGRSTRule',
    'SPEI_END_INPUT_STREAM', 'SPEI_TTS_PRIVATE',
    'DISPID_SPEPronunciation', 'DISPID_SPEs_NewEnum', 'SPAS_CLOSED',
    'SPFILEMODE', 'SPEI_MIN_TTS', 'SpStreamFormatConverter',
    'SpSharedRecognizer', 'DISPID_SOTDisplayUI',
    'SAFTCCITT_uLaw_8kHzStereo', 'ISpeechXMLRecoResult',
    'SAFTADPCM_44kHzMono', 'DISPID_SRRPhraseInfo', 'SPSHORTCUTTYPE',
    'SPPS_Interjection', 'DISPID_SGRSTsCount', 'DISPID_SBSFormat',
    'SREPropertyStringChange', 'SAFT32kHz16BitStereo',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SVAudioOutput',
    'SPADAPTATIONRELEVANCE', 'SPTEXTSELECTIONINFO',
    'DISPID_SPIAudioStreamPosition', 'SPINTERFERENCE_LATENCY_WARNING',
    'SpeechVisemeType', 'SPBINARYGRAMMAR', 'DISPID_SPAPhraseInfo',
    'DISPID_SRCEAudioLevel', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SRRGetXMLResult',
    'SpeechPartOfSpeech', 'ISpeechRecoGrammar', 'DISPID_SMSAMMHandle',
    'ISpRecoResult', 'SPEI_HYPOTHESIS', 'DISPID_SRGSetTextSelection',
    'SpeechTokenContext', 'SDA_Two_Trailing_Spaces',
    'SpeechAudioFormatType', 'SPCATEGORYTYPE', 'SDTPronunciation',
    'SREAllEvents', 'SPCT_SLEEP', 'SPWF_INPUT',
    'SAFT12kHz16BitStereo', 'DISPID_SPCPhoneToId',
    'SAFT16kHz8BitStereo', 'DISPID_SPELexicalForm',
    'Speech_StreamPos_RealTime', 'eLEXTYPE_RESERVED10',
    'SVEEndInputStream', 'SGRSTTRule', 'DISPID_SVSPhonemeId',
    'DISPID_SRSClsidEngine', 'DISPID_SDKSetStringValue',
    'DISPID_SpeechMemoryStream', 'DISPID_SpeechLexiconProns',
    'SECFIgnoreCase', 'SAFT22kHz16BitStereo', 'DISPID_SVStatus',
    'SPEI_START_SR_STREAM', 'DISPID_SPPsCount', 'SFTSREngine',
    'SPPS_Noun', 'SPCS_DISABLED', 'SAFTCCITT_uLaw_8kHzMono',
    'SpeechVoicePriority', 'ISpEventSink', 'ISpeechMMSysAudio',
    'SVF_Emphasis', 'SVP_7', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPID_SVEWord', 'ISpRecognizer3', 'SAFT48kHz16BitStereo',
    'SPCT_SUB_COMMAND', 'SPRECORESULTTIMES',
    'DISPID_SpeechRecoResult2', 'SpPhraseInfoBuilder',
    'ISpeechLexiconPronunciations', 'SP_VISEME_2',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SpeechPhraseProperty',
    'tagSTATSTG', 'SpeechAudioFormatGUIDWave',
    'DISPID_SRCVoicePurgeEvent', 'SVP_20', 'DISPID_SLPPartOfSpeech',
    '__MIDL_IWinTypes_0009', 'SRTExtendableParse',
    'DISPID_SASFreeBufferSpace', 'eLEXTYPE_USER',
    'SpeechPropertyComplexResponseSpeed', 'SPEI_FALSE_RECOGNITION',
    'SP_VISEME_13', 'DISPID_SVSLastResult', 'eLEXTYPE_APP',
    'DISPID_SMSSetData', 'DISPID_SPPConfidence',
    'DISPID_SPAStartElementInResult', 'SPSEMANTICERRORINFO',
    'DISPID_SABIEventBias', 'ISpeechLexiconWords',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SREFalseRecognition',
    'SVEVoiceChange', 'DISPID_SRGReset', 'DISPID_SpeechGrammarRules',
    'DISPID_SRAudioInputStream', 'SAFTNonStandardFormat',
    'SPINTERFERENCE_NONE', 'DISPID_SRGetFormat', 'SPVPRI_ALERT',
    'SBONone', 'SpeechTokenValueCLSID', 'DISPID_SVPriority',
    'SP_VISEME_1', 'SPRST_NUM_STATES', 'eWORDTYPE_ADDED',
    'SRTSMLTimeout', 'DISPID_SGRInitialState',
    'DISPIDSPTSI_SelectionOffset', 'SPPROPERTYINFO',
    'SAFTCCITT_uLaw_44kHzStereo', 'SPGRAMMARSTATE', 'DISPID_SRState',
    'eLEXTYPE_PRIVATE12', 'DISPID_SAVolume',
    'DISPID_SpeechAudioStatus', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SVESentenceBoundary', 'DISPID_SASState', 'DISPID_SVPause',
    'SPEI_SOUND_START', 'SVPOver', 'SpeechCategoryPhoneConverters',
    'ISpObjectTokenCategory', 'DISPID_SVGetProfiles',
    'DISPID_SVVolume', 'SVSFNLPMask', 'DISPID_SVResume',
    'SWPUnknownWordPronounceable', 'SPEI_TTS_BOOKMARK', 'SREBookmark',
    'DISPID_SPIProperties', 'SGLexicalNoSpecialChars',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SpeechPhraseElement',
    'SP_VISEME_20', 'SpNullPhoneConverter', 'SpCustomStream',
    'DISPID_SVSpeakStream', 'ISpeechPhraseReplacement',
    'SpeechDisplayAttributes', 'SpResourceManager', 'STCLocalServer',
    'SRARoot', 'SRERequestUI', 'SpeechRegistryUserRoot',
    'DISPID_SPRs_NewEnum', 'DISPID_SpeechLexicon',
    'ISpeechPhraseProperty', 'DISPID_SVGetAudioInputs', 'SVSFDefault',
    'SPSLMA', 'DISPID_SLPPhoneIds', 'DISPID_SPCLangId',
    'DISPID_SpeechPhraseInfo', 'DISPID_SGRsFindRule',
    'DISPID_SVSInputWordLength', 'SpeechAudioVolume',
    ...
    'DISPID_SPACommit', 'SpeechRecoProfileProperties',
    'DISPID_SGRSTWeight', 'SAFT16kHz16BitStereo',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SRSEDone',
    'DISPID_SGRAddResource', 'DISPID_SLGetWords',
    'eLEXTYPE_PRIVATE15', 'ISpeechPhraseElements',
    'DISPID_SRRSaveToMemory', 'DISPID_SRCERecognizerStateChange',
    'eLEXTYPE_PRIVATE17', 'DISPID_SRGetPropertyString',
    'DISPID_SMSGetData', 'SPPS_Verb',
    'DISPID_SASCurrentDevicePosition', 'SASStop', 'DISPID_SPPName',
    'Speech_StreamPos_Asap', 'DISPID_SASetState',
    'SAFT24kHz16BitMono', 'SPEI_RESERVED5', 'DISPID_SAStatus',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SPIEnginePrivateData',
    'SPEI_SR_BOOKMARK', 'SPGS_DISABLED', 'ISpeechPhraseReplacements',
    'SpeechCategoryAudioOut', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SOTRemove', 'DISPID_SPIRule', 'SWTDeleted',
    'DISPID_SOTCategory', 'SpeechAudioFormatGUIDText',
    'ISpeechRecoResultDispatch', 'SRESoundStart',
    'DISPID_SAFGetWaveFormatEx', 'SpTextSelectionInformation',
    'SPSInterjection', 'DISPID_SGRSTPropertyName',
    'DISPID_SRCAudioInInterferenceStatus', '_RemotableHandle',
    'SpStream', 'SREAudioLevel', 'SpMemoryStream',
    'DISPID_SpeechMMSysAudio', 'ISpNotifySink',
    'SPEI_RECO_OTHER_CONTEXT', 'eLEXTYPE_PRIVATE8', 'SVF_None',
    'IEnumString', 'SVSFParseMask', 'SPFM_NUM_MODES',
    'DISPID_SRCreateRecoContext',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SVAlertBoundary', 'DISPID_SRCEPhraseStart',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'DISPID_SGRClear',
    'SpCompressedLexicon', 'SGSDisabled', 'DISPID_SpeechPhraseRule',
    'DISPID_SPILanguageId', 'SP_VISEME_14', 'SpeechRuleState',
    'SSFMOpenReadWrite', 'DISPID_SWFESamplesPerSec',
    'DISPID_SpeechPhraseAlternate', 'SPWORDPRONOUNCEABLE',
    'ISpStreamFormatConverter', 'ISpeechLexiconPronunciation',
    'SSFMCreateForWrite', 'ISpeechPhraseElement',
    'DISPID_SpeechPhraseAlternates', 'SAFTNoAssignedFormat',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SRGDictationUnload', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SVEStreamEnd', 'DISPID_SOTCSetId', 'DISPID_SPAsCount',
    'SDTProperty', 'DISPID_SLGenerationId', 'SASClosed',
    'ISpPhoneticAlphabetSelection', 'ISpeechPhraseRules',
    'DISPID_SRSCurrentStreamPosition', 'ISpeechLexiconWord',
    'SP_VISEME_11', 'SPRST_INACTIVE', 'SRATopLevel',
    'SPEI_END_SR_STREAM', 'DISPID_SPPValue', 'SVSFNLPSpeakPunc',
    'SPWORDPRONUNCIATION', 'SPEI_MIN_SR', 'SPEI_ADAPTATION',
    'UINT_PTR', 'DISPID_SVSInputSentencePosition', 'SPPHRASE',
    'SPRST_ACTIVE', 'SpVoice', 'DISPIDSPTSI_SelectionLength', 'SVP_5',
    'DISPID_SPPChildren', 'SPBO_TIME_UNITS', '_SPAUDIOSTATE',
    'DISPID_SRCBookmark', 'SpeechGrammarTagWildcard',
    'SAFT11kHz8BitMono', 'WAVEFORMATEX', 'SPAR_Medium', 'SPSModifier',
    'DISPID_SPANumberOfElementsInResult', 'SPINTERFERENCE',
    'SVSFIsNotXML', 'DISPID_SPEAudioSizeTime', 'DISPID_SGRSTText',
    'SITooFast', 'SRADynamic', 'SREPrivate', 'SPFM_OPEN_READONLY',
    'DISPID_SDKEnumKeys', 'SDKLDefaultLocation',
    'IEnumSpObjectTokens', 'SAFT12kHz16BitMono', 'SPAR_High',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SVSpeak', 'DISPID_SRGId',
    'eLEXTYPE_PRIVATE16', 'ISpeechRecognizerStatus', 'SRAImport',
    'DISPID_SPRulesItem', 'SP_VISEME_0', 'DISPID_SGRsItem',
    'SAFT22kHz16BitMono', 'SGDSActive', 'SPPS_RESERVED3',
    'DISPID_SRCEventInterests', 'DISPID_SGRAddState',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SRCEHypothesis',
    'SpeechVisemeFeature', 'DISPID_SpeechFileStream',
    'ISpeechAudioStatus', 'DISPID_SCSBaseStream',
    'SAFT44kHz16BitMono', 'DISPID_SRGSetWordSequenceData',
    'SP_VISEME_6', 'SPEVENTENUM', 'SRCS_Disabled',
    'DISPID_SPIElements', 'DISPID_SGRName', 'SPAR_Unknown',
    'STSF_LocalAppData', 'ISpeechPhoneConverter',
    'SPEI_PROPERTY_NUM_CHANGE', 'ISpeechPhraseAlternates',
    'DISPID_SRDisplayUI', 'SpeechTokenShellFolder',
    'DISPID_SASNonBlockingIO', 'DISPID_SpeechRecognizer',
    'DISPID_SASCurrentSeekPosition', 'SAFT11kHz16BitMono',
    'SAFT16kHz16BitMono', 'SPEI_RECOGNITION',
    'DISPID_SOTCreateInstance', 'SDTLexicalForm',
    'ISpPhoneticAlphabetConverter', 'SPEI_UNDEFINED', 'SPXRO_SML',
    'SPEI_VISEME', 'SRSEIsSpeaking', 'SAFT48kHz8BitMono',
    'DISPID_SPIEngineId', 'SPEVENT', 'DISPID_SPERequiredConfidence',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SGRSTNextState', 'ISpPhrase',
    'SpeechTokenKeyAttributes', 'DISPID_SOTCGetDataKey',
    'SAFT24kHz16BitStereo', 'IStream', 'ISpStreamFormat',
    'ISpRecognizer', 'DISPID_SVSInputSentenceLength',
    'DISPID_SVEAudioLevel', 'eLEXTYPE_RESERVED4',
    'IInternetSecurityMgrSite', 'SPBO_PAUSE', 'ISpProperties',
    'SPWF_SRENGINE', 'DISPID_SPAs_NewEnum', 'SpeechBookmarkOptions',
    'DISPID_SGRId', 'SRTReSent', 'DISPID_SRProfile',
    'DISPID_SGRSTs_NewEnum', 'SPCONTEXTSTATE', 'SAFT48kHz8BitStereo',
    'DISPID_SRRAlternates', 'SAFT8kHz16BitMono', 'eLEXTYPE_RESERVED8',
    'SDTAlternates', 'SPPS_RESERVED4',
    'DISPID_SRCERecognitionForOtherContext', 'SVP_21',
    'SPEI_START_INPUT_STREAM', 'SRAORetainAudio', 'SPSHT_EMAIL',
    'DISPID_SRCSetAdaptationData', 'SAFTADPCM_22kHzStereo',
    'DISPID_SPISaveToMemory', 'SP_VISEME_5',
    'DISPID_SPRuleConfidence', 'DISPID_SPRuleFirstElement',
    'SP_VISEME_18', 'SpeechAudioProperties', 'SPPHRASEPROPERTY',
    'DISPID_SRCCmdMaxAlternates', 'SpPhoneConverter',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SPCIdToPhone',
    'SPPS_LMA', 'DISPID_SOTGetDescription', 'DISPID_SRCEInterference',
    'eLEXTYPE_RESERVED6', 'eLEXTYPE_PRIVATE19',
    'SpeechCategoryRecognizers', 'SAFTADPCM_11kHzStereo', 'SPSNoun',
    'DISPID_SOTCId', 'ISpRecognizer2',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SDKGetBinaryValue',
    'DISPID_SOTSetId', '_ISpeechVoiceEvents', 'DISPID_SVEBookmark',
    'SAFT12kHz8BitStereo', 'SPEI_PHONEME',
    'SpeechCategoryAppLexicons', 'SpeechPropertyAdaptationOn',
    'DISPID_SGRAttributes', 'SpeechDiscardType', 'SPGRAMMARWORDTYPE',
    'SPFM_CREATE', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SRADefaultToActive', 'DISPID_SDKEnumValues',
    'DISPID_SRCESoundEnd', 'SPAO_NONE', 'SPFM_OPEN_READWRITE',
    'ISpeechRecoContext', 'DISPID_SRRAudio', 'DISPID_SOTsCount',
    'ISpeechPhraseRule', 'SPWAVEFORMATTYPE',
    'DISPID_SRSetPropertyString', 'DISPID_SpeechVoiceStatus',
    'SP_VISEME_12', 'DISPID_SVEventInterests',
    'SpeechCategoryRecoProfiles', 'SPSMF_UPS',
    'DISPID_SVIsUISupported', 'DISPID_SGRs_NewEnum',
    'DISPID_SPIReplacements', 'SAFTCCITT_ALaw_22kHzStereo',
    'SECFEmulateResult', 'SVP_19', 'DISPID_SRStatus',
    'DISPID_SLRemovePronunciation', 'SPEI_PHRASE_START',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SPRNumberOfElements',
    'SSFMOpenForRead', 'DISPID_SPIGetText', 'SP_VISEME_16',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SPRuleId', 'SVP_10', 'SINoSignal',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SPPS_Modifier',
    'DISPID_SRCEFalseRecognition', 'DISPID_SGRSAddRuleTransition',
    'SVESentenceBoundary', 'DISPID_SRCCreateGrammar',
    'SAFT11kHz16BitStereo', 'SPSTREAMFORMATTYPE', 'DISPID_SPPsItem',
    'SP_VISEME_8', 'DISPID_SVSyncronousSpeakTimeout',
    'SAFTADPCM_8kHzStereo', 'SpLexicon', 'SpeechFormatType',
    'SPINTERFERENCE_TOOLOUD', 'eLEXTYPE_PRIVATE9',
    'DISPID_SpeechPhraseElements', 'SPGS_ENABLED',
    'DISPID_SLGetPronunciations', 'SpeechSpecialTransitionType',
    'SAFTADPCM_22kHzMono', 'DISPID_SGRSTPropertyValue',
    'DISPID_SDKSetBinaryValue', 'STSF_FlagCreate',
    'eLEXTYPE_PRIVATE3', 'SPEVENTSOURCEINFO',
    'SpeechGrammarTagDictation', 'SGSExclusive',
    'SAFTExtendedAudioFormat', 'SPRS_ACTIVE', 'ISpRecoGrammar',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SVP_17',
    'SWPKnownWordPronounceable', 'SpeechRecoContextState',
    'DISPID_SpeechRecoResultTimes', 'SVEViseme', 'eLEXTYPE_PRIVATE7',
    'SAFTCCITT_ALaw_44kHzMono', 'SAFT32kHz8BitStereo', 'LONG_PTR',
    'SPVPRI_OVER', 'DISPID_SVEStreamStart', 'DISPID_SDKOpenKey',
    'SREHypothesis', 'SVP_1', 'SAFTCCITT_uLaw_44kHzMono',
    'SpeechDictationTopicSpelling', 'DISPID_SWFEBitsPerSample',
    'ISpeechRecoResult2', 'SpSharedRecoContext', 'ISpDataKey',
    'DISPID_SRCEAdaptation', 'SGSEnabled', 'DISPID_SpeechGrammarRule',
    'SAFTADPCM_44kHzStereo', 'DISPID_SVSVisemeId',
    'SAFT22kHz8BitStereo', 'SVSFPersistXML', 'SpeechInterference',
    'SP_VISEME_21', 'DISPID_SLAddPronunciation',
    'SVSFParseAutodetect', 'SECLowConfidence',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'eLEXTYPE_PRIVATE6',
    'SPCT_COMMAND', 'SECFDefault', 'DISPID_SGRSTPropertyId',
    'SPPHRASERULE', 'DISPID_SRRTimes', 'SPWT_DISPLAY',
    'SAFTTrueSpeech_8kHz1BitMono', 'SVEStartInputStream',
    'SPDKL_CurrentUser', 'DISPID_SGRsDynamic',
    'ISpeechObjectTokenCategory',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SPRules_NewEnum', 'DISPID_SRCState', 'SDKLCurrentConfig',
    'SWTAdded', 'SVP_15', 'DISPID_SDKGetStringValue', 'SP_VISEME_3',
    'SAFTGSM610_11kHzMono', 'SP_VISEME_7', 'DISPID_SRCEBookmark',
    'SpeechCategoryVoices', 'ISpObjectWithToken',
    'DISPID_SPIAudioSizeTime',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'ISpeechCustomStream',
    'DISPID_SGRSTType', 'DISPID_SpeechGrammarRuleStateTransition',
    'SAFTDefault', 'SPEI_MAX_SR', 'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SPRuleParent', 'SAFTText', 'SP_VISEME_15',
    'SECHighConfidence', 'SRESoundEnd', 'SPPS_Function',
    'SPVOICESTATUS', 'SVP_18', 'DISPID_SWFEFormatTag',
    'SRAInterpreter', 'SPVPRIORITY', 'DISPID_SPPNumberOfElements',
    'DISPID_SBSSeek', 'DISPID_SVGetAudioOutputs',
    'DISPID_SRCEEndStream', 'SVP_13', 'DISPID_SGRSRule',
    'SpeechPropertyResourceUsage', 'SPRECOGNIZERSTATUS',
    'DISPID_SPIRetainedSizeBytes', 'ISpeechWaveFormatEx',
    'ISpeechAudio', 'SPEI_SOUND_END', 'SREPropertyNumChange',
    'SpeechGrammarState', 'SpeechVoiceEvents', 'SPEI_WORD_BOUNDARY',
    'SPSFunction', 'SPEI_SR_RETAINEDAUDIO', 'DISPID_SPRulesCount',
    'SREPhraseStart', 'SPWORDPRONUNCIATIONLIST',
    'SAFT8kHz16BitStereo', 'SVEBookmark', 'DISPID_SRGRules',
    'DISPID_SRCERequestUI', 'IInternetSecurityManager', 'ISpVoice',
    'DISPID_SpeechAudioBufferInfo', 'SPEI_MAX_TTS', 'SASPause',
    'SRSInactiveWithPurge', 'DISPID_SPPEngineConfidence',
    'SPEI_RESERVED2', 'SPCT_DICTATION', 'DISPID_SPARecoResult',
    'DISPID_SRCCreateResultFromMemory', 'SPRULE', 'SpFileStream',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SBSWrite',
    'DISPID_SABufferInfo', 'DISPID_SABIMinNotification',
    'DISPID_SRGCmdLoadFromResource', 'SDA_Consume_Leading_Spaces',
    'SPAUDIOBUFFERINFO', 'DISPID_SpeechWaveFormatEx',
    'SREStreamStart', 'SpeechRuleAttributes', 'ISpeechDataKey',
    'DISPID_SPEDisplayText', 'SPDKL_CurrentConfig',
    'ISpeechPhraseInfo', 'SPCT_SUB_DICTATION',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SRSAudioStatus',
    'SVP_4', 'DISPID_SVSCurrentStreamNumber', 'ISpRecoCategory',
    'DISPID_SVWaitUntilDone', 'DISPID_SPEsCount', 'SLTUser',
    'SPAS_PAUSE', 'ISpRecoGrammar2', 'SPBOOKMARKOPTIONS',
    'DISPID_SpeechPhoneConverter', 'SAFT44kHz8BitStereo',
    'DISPID_SGRSAddWordTransition', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SLWsCount', 'DISPID_SVEViseme', 'ISpMMSysAudio',
    'ISpeechPhraseAlternate', 'SVP_14',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SOTDataKey',
    'DISPID_SLPsItem', 'SPSVerb', 'ISpeechGrammarRules', 'SASRun',
    'ISpShortcut', 'SpeechPropertyLowConfidenceThreshold',
    'SDA_No_Trailing_Space', 'SRAONone', 'DISPID_SRRTLength',
    'DISPID_SRGIsPronounceable', 'DISPIDSPTSI', 'SpNotifyTranslator',
    'ISpeechTextSelectionInformation', 'SGRSTTWildcard',
    'SAFT22kHz8BitMono', 'SPRECOCONTEXTSTATUS', 'DISPID_SLPSymbolic',
    'SVF_Stressed', 'DISPID_SVDisplayUI', 'SVEAudioLevel',
    'SLOStatic', 'SpAudioFormat', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SVRate', 'SPSHT_Unknown',
    'SPEI_RESERVED6', 'DISPID_SGRSTsItem', 'DISPID_SGRSTransitions',
    'DISPID_SRGCmdLoadFromObject', 'SPINTERFERENCE_NOSIGNAL',
    'ISpXMLRecoResult', 'DISPID_SBSRead', 'DISPID_SpeechVoiceEvent',
    'SDTAudio', 'DISPID_SPPBRestorePhraseFromMemory',
    'eLEXTYPE_PRIVATE11', 'SPAO_RETAIN_AUDIO', 'SGDisplay',
    'DISPID_SpeechRecoResult', 'ISpeechRecognizer'
]

_check_version('1.2.0', 1683289287.767849)
